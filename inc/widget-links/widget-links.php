...
class SimpleLinkListWidget extends WP_Widget {
    ...
    public function __construct() {
        ...
        add_action('admin_enqueue_scripts', array($this, 'wlinks_load_scripts'));
    }
    ...
    public function form($instance) {
        ...
        <div class="simple-link-list">
            ...
            foreach ($items as $num => $item) :
                ...
                <div id="<?php echo $this->get_field_id($num); ?>" class="list-item">
                    <h5 class="moving-handle"><span class="number"><?php echo $num; ?></span>. <span class="item-title"><?php echo $item; ?></span><a class="wlinks-action hide-if-no-js"></a></h5>
                    <div class="wlinks-edit-item">
                        ...
                        <span style="font-size:11px; display: block;"><?php echo __("Include http://"); ?></span>
                        ...
                        <a class="wlinks-delete hide-if-no-js"><img src="<?php bloginfo('template_url'); ?>/inc/widget-links/images/delete.png" /> <?php echo __("Remove"); ?></a>
                    </div>
                </div>
        ...
        <div class="wlinks-row hide-if-no-js">
            <a class="wlinks-add button-secondary"><img src="<?php bloginfo('template_url'); ?>/inc/widget-links/images/add.png" /> <?php echo __("Add Item"); ?></a>
        </div>
    ...
    public function wlinks_load_scripts($hook) {
        if ($hook != 'widgets.php')
            return;
        if (!isset($_GET['editwidget'])) {
            wp_enqueue_script('wlinks-js', get_template_directory_uri() . '/inc/widget-links/js/wlinks.js');
        }
        wp_enqueue_style('wlinks-css', get_template_directory_uri() . '/inc/widget-links/css/wlinks.css');
    }
